...
def fetch_defender_incidents():
    ...
    for i in range(target_count):
        ...
        if template['type'] == 'DLP':
            ...
            entities = [
                {'type': 'User', 'name': '<USERNAME>@<YOUR_DOMAIN>', 'verdict': 'suspicious'},
            ...
            entities = [
                {'type': 'User', 'name': 'phishme@<YOUR_DOMAIN>', 'verdict': 'suspicious'},
            ...
            entities = [{'type': 'User', 'name': f'user{incident_id}@<YOUR_DOMAIN>', 'verdict': 'unknown'}]
